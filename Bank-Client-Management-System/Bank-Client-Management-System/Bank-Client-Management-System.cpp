...
{
    cout << PrintLine("-", 50) << endl;
    cout << PrintLine(" ", 6) << "Find Client Screen\n";
    cout << PrintLine("-", 50) << endl;
...
{
    cout << PrintLine("-", 50) << endl;
    cout << PrintLine(" ", 10) << "Program Ends :-)\n";
    cout << PrintLine("-", 50) << endl;
}
...
void ShowMainMenue()
{
    ...
    cout << "            [6] Exit.\n";
    cout << "=================================================" << endl;
    PerformMainMenueOptions((enMainMenueOptions)ReadNumberInRange("Choose what do you want to do? [1 to 6]: ", 1, 6));
}
